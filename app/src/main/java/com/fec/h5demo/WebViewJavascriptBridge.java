...
public class WebViewJavascriptBridge implements Serializable {
    ...
    private class MyWebChromeClient extends WebChromeClient {
        ...
        @Override
        public boolean onJsAlert(WebView view, String url, String message, JsResult result) {//重写了alert
    ...
    public void _handleMessageFromJs(final String data,String responseId,
        ...
        if (null!=responseId) {
            ...
            if (null!=handlerName) {
                ...
                if (null==handler) {
                    Log.e("来自Js","WVJB Warning: No handler for "+handlerName);
                    return ;
                }
            } else {
            ...
            try {
                ...
                Log.e("来自Js","WebViewJavascriptBridge: WARNING: java handler threw. "+exception.getMessage());
            }
        }
    }
    ...
    private void _dispatchMessage(Map <String, String> message){
        ...
        Log.d("来自Js","sending:"+messageJSON);
